...
func GeneratePRContent(config *Config, diff string) (title, body string, err error) {
...
func buildTitlePrompt(config *Config, diff string) string {
...
func buildBodyPrompt(config *Config, diff string) string {
